...
This file is for UI architecture and visual implementation rules only.

Do not include product features.
Do not describe app pages.
Do not define user flows.
Do not invent requirements.
Do not mention specific feature modules.
